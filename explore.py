...
zipwherefound = summary['Zip Where Found']
...
zipwherefound[0] = zipwherefound["EMPTY"]
del zipwherefound["EMPTY"]

zipwherefound = dict((float(k), v) for k, v in zipwherefound.iteritems())
plt.bar(zipwherefound.keys(), zipwherefound.values())
plt.show()
# make a bar plot of all the latitudes we found

#plt.bar(intakeYear.keys(), intakeYear.values())
#plt.show()
# you may want to explore other visualizations
# such as a histogram or other aspects of the data 
# including other columns
intakeyear = summary['IntakeYear']
intakeyear = dict((float(k), v) for k, v in intakeyear.iteritems())
plt.bar(intakeyear.keys(), intakeyear.values())
plt.show()

intakemonth = summary['IntakeMonth']

intakemonth[1] = intakemonth["January"]
intakemonth[2] = intakemonth["February"]
intakemonth[3] = intakemonth["March"]
intakemonth[4] = intakemonth["April"]
intakemonth[5] = intakemonth["May"]
intakemonth[6] = intakemonth["June"]
intakemonth[7] = intakemonth["July"]
intakemonth[8] = intakemonth["August"]
intakemonth[9] = intakemonth["September"]
intakemonth[10] = intakemonth["October"]
intakemonth[11] = intakemonth["November"]
intakemonth[12] = intakemonth["December"]
#intakemonth[0] = intakemonth["EMPTY"]
del intakemonth["January"]
del intakemonth["February"]
del intakemonth["March"]
del intakemonth["April"]
del intakemonth["May"]
del intakemonth["June"]
del intakemonth["July"]
del intakemonth["August"]
del intakemonth["September"]
del intakemonth["October"]
del intakemonth["November"]
del intakemonth["December"]

intakemonth = dict((float(k), v) for k, v in intakemonth.iteritems())

plt.bar(intakemonth.keys(), intakemonth.values())
plt.show()
